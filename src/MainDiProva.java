...
public class MainDiProva {
	...
	public static void main(String[] args) throws Exception {
		...
		db.updateDatiCotta(c.getId(), c.getRicetta(), c.getData(), c.getLuogo(), c.getQuantitàAcqua(), c.getLuogoAcqua(), c.getSaliMinerali(), c.getNote(), c.getFaseCorrente());
		...
		for(int j=0; j<g.size(); j++){
			...
			System.out.println(g.get(j).getQuantità());
		...
		System.out.println(db.insertGittataBollitura(g1.getNum_gittata(), 3, g1.getIngrediente().getId(), null, g1.getQuantità()));
		GittataFermentazione g2=new GittataFermentazione(7, ing, 270, LocalDate.of(2016, 8, 30));
		System.out.println(db.insertGittataFermentazione(g2.getNum_gittata(), 3, ing.getId(),  LocalDate.now(), g2.getQuantità()));
		GittataRaffreddamento g3=new GittataRaffreddamento(5, db.getIngredienteFromId(4), 3, LocalTime.of(15, 30));
		System.out.println(db.insertGittataRaffreddamento(11, 3, ing.getId(), g3.getOrario(), g3.getQuantità()));
		...
		db.deleteStile(i);*/
		//System.out.println("Inserita una categoria con id="+db.insertCategoria("Questa è una prova", "ciao a tutti"));
		//int i=db.insertCategoria("altra prova", null);
		//System.out.println(db.insertCategoria("prova", null));
		//System.out.println(db.updateCategoria(23, "prova1", "Adesso c'è una nota"));
		...
		((Lievito) ing).setQuantità_busta(3);
		...
		System.out.println(g.getQuantità());
		...
		/*try{
			...
			System.out.println(a1.getDensità());
		...
		System.out.println(a2.getDensità());
		...
		for(int i=0; i<lista.size(); i++){
			...
			System.out.println(lista.get(i).getQuantità());
